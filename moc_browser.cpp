...
#include "../../../Google-Hacking/browser.h"
...
QT_MOC_LITERAL(1, 8, 21), // "on_webView_urlChanged"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 4) // "arg1"

    },
    "browser\0on_webView_urlChanged\0\0arg1"
};
...
void browser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_webView_urlChanged((*reinterpret_cast< const QUrl(*)>(_a[1]))); break;
        default: ;
        }
    }
}
